...
<x-layouts.app title="Dashboard — Kebon Jeruk Multiguna">
    <div class="band py-xl md:py-xxl">
        ...
        <div class="mb-xxl grid grid-cols-1 gap-lg sm:grid-cols-2 lg:grid-cols-[1fr_1fr_1.4fr]">
            <x-ui.stat tone="cream" label="Aplikasi dibawa" :value="$carried" note="Sejak akun aktif" />
            <x-ui.stat tone="mint" label="Telah Go Live" :value="$goLive" note="Actual Lending" />
        ...
        <h2 class="mb-md text-title-lg text-ink">Aplikasi terbaru</h2>
