...
final class Defaults extends AuditedAdminComponent
{
    private const DEFINITIONS = [
        ...
        'view_sprint_cara_pembayaran' => ['label' => 'View Sprint · Cara Pembayaran', 'type' => 'text'],
        'view_sprint_mandiri_kpm' => ['label' => 'View Sprint · Mandiri KPM (KKB)', 'type' => 'text'],
        'view_sprint_kondisi_kendaraan' => ['label' => 'View Sprint · Kondisi Kendaraan', 'type' => 'text'],
        'view_sprint_is_beliv' => ['label' => 'View Sprint · Is BELIV?', 'type' => 'text'],
        'view_sprint_acp_axp' => ['label' => 'View Sprint · ACP & AXP', 'type' => 'text'],
        'view_sprint_gap' => ['label' => 'View Sprint · GAP', 'type' => 'text'],
        'view_sprint_hic' => ['label' => 'View Sprint · HIC', 'type' => 'text'],
        'view_sprint_water_hammer' => ['label' => 'View Sprint · Water Hammer & Theft by Driver', 'type' => 'text'],
